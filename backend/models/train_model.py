...
def train_models(X, y):
    ...
    print("\n📌 Logistic Regression Evaluation:")
    evaluate_model(y_test, y_pred_lr, y_prob_lr)
    joblib.dump(lr, "models/logistic_best_model.pkl")
    ...
    print("\n📌 Random Forest Evaluation:")
    evaluate_model(y_test, y_pred_rf, y_prob_rf)
    joblib.dump(rf, "models/random_forest_best_model.pkl")

    print("\n✅ Models saved to 'models/' folder.")

    # Save feature column names for inference reindexing
...
if __name__ == "__main__":
    print("📥 Preprocessing full dataset from MongoDB...")
    X, y = preprocess(is_inference=False)
